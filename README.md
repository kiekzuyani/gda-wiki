...
- [Lore](#lore)
    - [Lore - O começo de tudo (2012-2017)](#)
        - [Lore - Nardo, aLp e Brassos: crossfire e betas](#)
        - [Lore - SAMP: NRG](#)
        - [Lore - Minecraft: survival, factions e minigames](#)
        - [Lore - SAMP: karaokê de admins](#)
        - [Lore - League of Legends: bots e bronzes](#)
        - [Lore - Drei e Nardo's Sidequest: 3v3, boyloko007 e companhia](#)
    - [Lore - Alla e Nardo: bootcamp, cheats, racing e mice pirata (2017-2018)](#lore---alla-e-nardo-bootcamp-cheats-racing-e-mice-pirata-2017-2018)
    - [Lore - Okd (2018-2020)](#lore---okd-episódio-1-2018-2019)
        - [Lore - Okd: episódio 1 (2018-2019)](#lore---okd-episódio-1-2018-2019)
        - [Lore - Okd: episódio 2 (2019-2020)](#lore---okd-episódio-2-2019-2020)
    - [Lore - GDA: episódio 1](#)
    - [Lore - CGM: episódio 1](#)
    - [Lore - GDA: episódio 2](#)
    - [Lore - ImJustAGirl](#)
...
- [Felipe A.](#)
(A.K.A lipe, hazard, lipe pjl irmao)
...
- [Leonardo S.](#)
(A.K.A alp, alpenis, zalp, leozin, leo)
...
- [M1216: o maior terror de Jonas e amigos](#)
- [Uma história SAMP: karaokê, homossexualismo e administração](#)
...
- [Corrida ao topo: Wash, Alla e Nardo disputam o pódio](#)
- [Alla e o triângulo amoroso ft. Letícia e Samz](#)
- [Facebook, Akatsuki, U know da wae e Ana Kb: uma história Allan ViTor Gonçalves](#)
...
- [BORBAO vs. Otas: lost in translation](#)
...
- [zhiendoka from yasuo trilogy](#)
- [Alla ensina como jogar de Kayn mid: 200 de dano](#)
- [Alla e seu temido Master Yi de 2000 de dano no URF](#)
- [Juao resetando o red](#)
- [O inexplicável acontece: Juao e o edit de lol no status](#)
- [GDA: uma história CSGO](#)
- [Nardo, uma Eagle, e um sonho: Alã vai à loucura na Overpass](#)
...
Após os dois entrarem na [Okd](#), eles continuaram jogando transformice porém também passavam todos os dias conversando no servidor da [Okd](#) no discord, tanto em call como em texto. Essa época do discord é referenciada como **tempos sombrios**, pois a zoação, discussão e humor negro não tinham limites. [Nardo](#) era um tanto extremo com as brincadeiras referentes ao [Alla](#) e o [pegava para cristo](#).
Na [Okd](#) originaram-se diversos memes internos e hoje em dia relíquias do tempo, como [fotos antigas do alla](#), [zhiendoka e o mano sem camisa com poster do justin bieber](#), [cade o pronome mlk](#), [edits do neito](#), [meu primo é da roça](#), [alla hulk cinéfilo](#), [alla pau broxou](#) e [vídeos antigos do nardo](#), como [zhiendoka illuminati confirmado](#).

> [!NOTE]
> Adicionar prints da okd, foto antiga do alla, zhiendoka poster do bieber, cade o pronome, edits do neito, meu primo é da roça, alla hulk cinefilo, alla pau broxou, videos antigos do nardo

Discussões e ameaças de morte eram constantes no servidor, principalmente entre [Alla](#) e [Neito](#). Houveram alguns acontecimentos e incidentes marcantes, como a [treta entre o Neito e o Lipe por conta da **(nome da web do lipe)**](#).

> [!NOTE]
> Adicionar nome da web do lipe e print do neito falando com ela

Nesse tempo foram criados alguns grupos de WhatsApp, um dos primeiros, senão o primeiro, foi criado com [Alla](#), [Nardo](#), [Marquinhos](#) e [Breno](#), onde originou-se o meme interno [o cara vende chinelo pra pegar mulher](#), uma paródia da página no facebook, na época famosa, “o cara malha pra pegar mulher”. Esse meme era uma referência ao fato do [Marquinhos](#) ser vendedor de chinelos na 25 de março.

> [!NOTE]
> Adicionar print da página do chinelo

### Lore - Okd: episódio 2 (2019-2020)

[Alla](#) tinha uma família de roleplay no Habbo. Um dia ele bloqueou uma de suas amigas que faziam parte dessa família, e isso deu início à [perseguição de Yasmin](#). [Alla](#) estava sendo perseguido nas redes sociais por [Yasmin](#), e isso fez com que ela enviasse uma mensagem para o [Juao](#) no Facebook, pois [Nardo](#) costumava [marcar o Alla em posts no facebook junto com o Juao](#).

> [!NOTE]
> Adicionar print do "Allan ViTor Goncalves Bassedoni"

[Yasmin](#) enviou a mensagem perguntando se [Juao](#) conhecia o [Alla](#) e pediu para que ele pedisse ao [Alla](#) que entrasse em contato com ela. [Juao](#), sem entender nada, enviou o print dessa mensagem para o [Nardo](#) – e o [Nardo](#) enviou o print do print para o [Alla](#). [Nardo](#) então criou um grupo no facebook messenger com eles três para conversarem sobre. Esse acontecimento deu início à futura [amizade entre Alla e Juao](#).

> [!NOTE]
> Adicionar print da mensagem da Yasmin

Após o [Yasmin Incident](#), [Juao](#) foi introduzido ao servidor da [Okd](#). Foi criado então o [primeiro grupo do WhatsApp que futuramente se tornaria o GDA](#), o qual era composto primariamente por [Alla](#), [Nardo](#), [Juao](#), [Lipe](#) e [Kaio](#).

> [!NOTE]
> Adicionar print desse grupo

Depois de um tempo, houve a junção entre o servidor de discord da [Okd](#) e o servidor [Aztroboys](#). Com essa junção, entraram diversos novos membros no servidor.

Com essa junção, [Alla](#) conheceu e introduziu um novo membro ao grupo do WhatsApp, o [Otas](#).
